...
<body>
	...
	<div id="titulo"><div class="form-inline" role="form"><span style="font-size:25px;" > &nbsp;&nbsp;&nbsp;Actividades</span></div></div>        
	<table id="tabla" data-toggle="table" class="table table-striped table-hover"  data-url="ajax/actividades.ajax.php?accion=actividadesjson" data-click-to-select="true" data-search="true" data-show-refresh="true" data-toolbar="#titulo">
	    <thead>
		    <tr>
	            ...
	            <th data-field="fecha_inicio" data-align="center">Fecha Inicia</th>
	            <th data-field="fecha_fin" data-align="center">Fecha Finaliza</th>
	            <th data-field="hora_inicio" data-align="center">Hora Inicia</th>
	            <th data-field="hora_fin" data-align="center">Hora Finaliza</th>
	            <th data-field="objetivo" data-align="center">Objetivo</th>
