...
<body>
	...
	<div id="titulo"><div class="form-inline" role="form"><span style="font-size:25px;" > &nbsp;&nbsp;&nbsp;Comentarios y sugerencias</span></div></div>        
	<table id="tabla" data-toggle="table" class="table table-striped table-hover"  data-url="ajax/sugerencias.ajax.php?accion=sugerenciasjson" data-click-to-select="true" data-search="true" data-show-refresh="true" data-toolbar="#titulo">
	    <thead>
		    <tr>
