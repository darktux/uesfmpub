...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tPreview = '<div class="file-preview {class}">\n' +
            ...
            '    <div class="{dropClass}">\n' +
            '    <div id="miniaturas" class="file-preview-thumbnails">\n' +
            '    </div>\n' +
    ...
    FileInput.prototype = {
        ...
        renderRemove: function () {
            ...
            return '<button id="cancelfile01" type="button" title="' + self.removeTitle + '" class="' + css + '"' + status + '>' + self.removeIcon + self.removeLabel + '</button>';
        },
        ...
        renderUpload: function () {
            ...
            if (!self.isUploadable || self.isDisabled) {
                ...
                content = '<a id="submitfile01" href="' + self.uploadUrl + '" title="' + self.uploadTitle + '" class="' + css + '"' + status + '>' + self.uploadIcon + self.uploadLabel + '</a>';
            }
            return content;
        }
    };
    ...
    $.fn.fileinput.locales.en = {
        ...
        dropZoneTitle: 'Arrastre y suelte imágenes aquí &hellip;'
    };
